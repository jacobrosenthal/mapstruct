...
VENDORED, NOT WRITTEN HERE. mpyq 0.2.5 by Aku Kotkavuo and contributors,
two-clause BSD - the full licence is in tools/mpyq-LICENSE and redistribution in
source form is what it explicitly permits. Copied in unmodified apart from this
note so that a fresh copy of this repository needs no pip install: every tool
here puts tools/ on sys.path before importing it, so this copy is what they get
whether or not the machine has one.

Upstream: https://github.com/eagleflo/mpyq
"""
